# 👋 Olá, eu sou Pedro Barreto

💻 Estudante de **Desenvolvimento de Sistemas na ETEC**  
🛠 Experiência em **Suporte Técnico de TI**  
📍 Arujá - SP, Brasil  

Atualmente estou estudando programação e tecnologia com foco em desenvolvimento e infraestrutura de TI.

## 🚀 Sobre mim

- 🎓 Cursando **Desenvolvimento de Sistemas - ETEC**
- 💼 Experiência como **Auxiliar de Informática**
- 🔧 Suporte técnico, instalação e manutenção de computadores
- 🌐 Interesse em **programação, redes e segurança da informação**
